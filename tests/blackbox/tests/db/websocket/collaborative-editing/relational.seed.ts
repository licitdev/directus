...
export const collectionCollabRelationalM2MJunction = 'test_collab_relational_m2m_jct';
export const collectionCollabRelationalM2M = 'test_collab_relational_m2m';
export const collectionCollabRelationalA2OJunction = 'test_collab_relational_a2o_jct';
